...
def main():
    ...
    print("Extracting Track A Vowel-only features (0ms to +80ms)...")
    X_deg, y_class, meta = extractor.extract_diagnostic_features(speakers, target_type='vowel', vowel_dur_ms=80.0)
    ...
    print("Training Logistic Regression on Vowels...")
    ...
    plt.title("Diagnostic Step 2: Vowel-Only Confusion Matrix")
    plt.ylabel('True Class')
    plt.xlabel('Predicted Class')
    
    out_path = os.path.join(os.path.dirname(__file__), 'confusion_matrix_vowel_only.png')
