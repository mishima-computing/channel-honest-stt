...
def main():
    ...
    print("Extracting transient features with Vowel-Anchor [-80ms, 0ms] window...")
    X_deg, y_class, meta = extractor.extract_transient_vowel_anchor_80ms(speakers)
    ...
    print("Training Logistic Regression on 80ms Vowel-Anchor Transients...")
    ...
    print("\nClassification Report (80ms Vowel-Anchor Transients):")
    ...
    plt.title("Diagnostic Step 5: Vowel-Anchor 80ms Transient Confusion Matrix")
    plt.ylabel('True Class')
    plt.xlabel('Predicted Class')
    
    out_path = os.path.join(os.path.dirname(__file__), 'confusion_matrix_transient_80ms.png')
