...
def main():
    ...
    print("Extracting burst-aligned transient features (-20ms to +40ms relative to burst)...")
    X_deg, y_class, meta = extractor.extract_transient_burst_aligned(speakers, burst_pre_ms=20.0, burst_post_ms=40.0)
    ...
    class_order = [
        ...
        'Unvoiced Affricate', 'Voiced Affricate/Fricative'
    ]
    ...
    print("Training Logistic Regression on Burst-Aligned Transients...")
    ...
    print("\nClassification Report (Burst-Aligned Transients):")
    ...
    plt.title("Diagnostic Step 4: Burst-Aligned Transient Confusion Matrix")
    plt.ylabel('True Class')
    plt.xlabel('Predicted Class')
    
    out_path = os.path.join(os.path.dirname(__file__), 'confusion_matrix_transient_burst_aligned.png')
