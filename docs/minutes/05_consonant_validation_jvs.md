...
一方で、このクリーンな測定系においても、**無声破擦（11%）と有声破擦・摩擦（26%）は依然として壊滅的な正答率**を示し、無声摩擦や破裂音へと流れた。これにより、「破擦音の摩擦成分は電話帯域において真に分離困難である」という物理的限界がアーティファクト抜きで証明され、「混ざるものは畳む」という設計判断の真の根拠が得られた。
- 将来（本物音源＋実回線劣化）：Phase2の最終仕上げ
