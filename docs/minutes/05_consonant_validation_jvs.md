...
- **結論**: バーストと摩擦成分を完璧に窓の中央に収めた状態でも分類が破綻したことから、測定系の問題(b)は完全に棄却され、**「破擦音の高周波の摩擦成分は電話帯域において真に情報量を失い、単なる破裂音と区別がつかなくなる（物理的限界(a)）」**ことが最終的に確定した。これにより、「破擦音を破裂音や摩擦音にマージ（畳み込み）する」という設計判断が、一切のアーティファクトなしに裏付けられた。
- 将来（本物音源＋実回線劣化）：Phase2の最終仕上げ
